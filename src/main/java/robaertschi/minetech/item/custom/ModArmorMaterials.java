...
public enum ModArmorMaterials implements StringRepresentable, ArmorMaterial {
    MODULAR_ARMOR("modular_armor", 40, Util.make(new EnumMap<>(ArmorItem.Type.class), typeIntegerEnumMap -> {
    ...
    }), 20, SoundEvents.ARMOR_EQUIP_NETHERITE, 3.2f, 0.2f, Ingredient::of);
